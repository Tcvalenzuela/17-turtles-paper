import argparse
parser = argparse.ArgumentParser(description= "Identify if TE are in genetic feature")
...
for ele in Gffgene:
    for rec in TEStarts:
        if Gffgene[ele][2]!= TEStarts[rec][1]:
            ...
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2Downstream_"+ "gene" +"\t"+ ele)
        elif Gffgene[ele][0] >= TEStarts[rec][0] and Gffgene[ele][0] < TEEnds[rec] and  Gffgene[ele][1] >= TEEnds[rec] and TEStarts[rec][0] < Gffgene[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2upstream_"+"gene" +"\t"+ ele)
        elif Gffgene[ele][0] == TEStarts[rec][0] and Gffgene[ele][0] < TEEnds[rec] and  Gffgene[ele][1] == TEEnds[rec] and TEStarts[rec][0] < Gffgene[ele][1] :
            print (rec.rstrip("\n") +"\t"+ "TE_exactly_"+ "gene"+"\t" + ele)
for ele in GffmRNA:
    for rec in TEStarts:
        if GffmRNA[ele][2]!= TEStarts[rec][1]:
            ...
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2Downstream_"+ "mRNA" +"\t"+ ele)
        elif GffmRNA[ele][0] >= TEStarts[rec][0] and GffmRNA[ele][0] < TEEnds[rec] and  GffmRNA[ele][1] >= TEEnds[rec] and TEStarts[rec][0] < GffmRNA[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2upstream_"+"mRNA" +"\t"+ ele)
        elif GffmRNA[ele][0] == TEStarts[rec][0] and GffmRNA[ele][0] < TEEnds[rec] and  GffmRNA[ele][1] == TEEnds[rec] and TEStarts[rec][0] < GffmRNA[ele][1] :
            print (rec.rstrip("\n") +"\t"+ "TE_exactly_"+ "mRNA"+"\t" + ele)
for ele in Gffexon:
    for rec in TEStarts:
        if Gffexon[ele][2]!= TEStarts[rec][1]:
            ...
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2Downstream_"+ "exon" +"\t"+ ele)
        elif Gffexon[ele][0] >= TEStarts[rec][0] and Gffexon[ele][0] < TEEnds[rec] and  Gffexon[ele][1] >= TEEnds[rec] and TEStarts[rec][0] < Gffexon[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2upstream_"+"exon" +"\t"+ ele)
        elif Gffexon[ele][0] == TEStarts[rec][0] and Gffexon[ele][0] < TEEnds[rec] and  Gffexon[ele][1] == TEEnds[rec] and TEStarts[rec][0] < Gffexon[ele][1] :
            print (rec.rstrip("\n") +"\t"+ "TE_exactly_"+ "exon"+"\t" + ele)
for ele in GffCDS:
    for rec in TEStarts:
        if GffCDS[ele][2]!= TEStarts[rec][1]:
            ...
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2Downstream_"+ "CDS" +"\t"+ ele)
        elif GffCDS[ele][0] >= TEStarts[rec][0] and GffCDS[ele][0] < TEEnds[rec] and  GffCDS[ele][1] >= TEEnds[rec] and TEStarts[rec][0] < GffCDS[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2upstream_"+"CDS" +"\t"+ ele)
        elif GffCDS[ele][0] == TEStarts[rec][0] and GffCDS[ele][0] < TEEnds[rec] and  GffCDS[ele][1] == TEEnds[rec] and TEStarts[rec][0] < GffCDS[ele][1] :
            print (rec.rstrip("\n") +"\t"+ "TE_exactly_"+ "CDS"+"\t" + ele)
for ele in Gfftranscript:
    for rec in TEStarts:
        if Gfftranscript[ele][2]!= TEStarts[rec][1]:
            ...
            print (rec.rstrip("\n") +"\t"+ "transcript" + "_inside_TE"+"\t" +ele)
        elif Gfftranscript[ele][0] < TEStarts[rec][0] and Gfftranscript[ele][0] < TEEnds[rec] and  Gfftranscript[ele][1] > TEEnds[rec] and TEStarts[rec][0] < Gfftranscript[ele][1]:
            print (rec.rstrip("\n") + "\t"+"TE_inside_"+ "transcript" +"\t"+ ele)
        elif Gfftranscript[ele][0] <= TEStarts[rec][0] and Gfftranscript[ele][0] < TEEnds[rec] and  Gfftranscript[ele][1] <= TEEnds[rec] and TEStarts[rec][0] < Gfftranscript[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2Downstream_"+ "transcript" +"\t"+ ele)
        elif Gfftranscript[ele][0] >= TEStarts[rec][0] and Gfftranscript[ele][0] < TEEnds[rec] and  Gfftranscript[ele][1] >= TEEnds[rec] and TEStarts[rec][0] < Gfftranscript[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2upstream_"+"transcript" +"\t"+ ele)
        elif Gfftranscript[ele][0] == TEStarts[rec][0] and Gfftranscript[ele][0] < TEEnds[rec] and  Gfftranscript[ele][1] == TEEnds[rec] and TEStarts[rec][0] < Gfftranscript[ele][1] :
            print (rec.rstrip("\n") +"\t"+ "TE_exactly_"+ "transcript"+"\t" + ele)
for ele in GffcDNA_match:
    for rec in TEStarts:
        if GffcDNA_match[ele][2]!= TEStarts[rec][1]:
            ...
            print (rec.rstrip("\n") +"\t"+ "cDNA_match" + "_inside_TE"+"\t" +ele)
        elif GffcDNA_match[ele][0] < TEStarts[rec][0] and GffcDNA_match[ele][0] < TEEnds[rec] and  GffcDNA_match[ele][1] > TEEnds[rec] and TEStarts[rec][0] < GffcDNA_match[ele][1]:
            print (rec.rstrip("\n") + "\t"+"TE_inside_"+ "cDNA_match" +"\t"+ ele)
        elif GffcDNA_match[ele][0] <= TEStarts[rec][0] and GffcDNA_match[ele][0] < TEEnds[rec] and  GffcDNA_match[ele][1] <= TEEnds[rec] and TEStarts[rec][0] < GffcDNA_match[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2Downstream_"+ "cDNA_match" +"\t"+ ele)
        elif GffcDNA_match[ele][0] >= TEStarts[rec][0] and GffcDNA_match[ele][0] < TEEnds[rec] and  GffcDNA_match[ele][1] >= TEEnds[rec] and TEStarts[rec][0] < GffcDNA_match[ele][1]:
            print (rec.rstrip("\n") +"\t"+ "TE_fromInside2upstream_"+"cDNA_match" +"\t"+ ele)
        elif GffcDNA_match[ele][0] == TEStarts[rec][0] and GffcDNA_match[ele][0] < TEEnds[rec] and  GffcDNA_match[ele][1] == TEEnds[rec] and TEStarts[rec][0] < GffcDNA_match[ele][1] :
            print (rec.rstrip("\n") +"\t"+ "TE_exactly_"+ "cDNA_match"+"\t" + ele)
